...
bool fetchLastStates() {
  ...
  if (Firebase.RTDB.getJSON(&firebaseData, "/clients/nhw3HWHVhvcRRKdPJFj3tEZzala2/boards/B001/appliances/")) {
      ...
      if (desiredApplianceState != localStates[i]) {
        ...
        if (Firebase.ready()) {
          Firebase.RTDB.setBool(&firebaseData,
            "/clients/nhw3HWHVhvcRRKdPJFj3tEZzala2/boards/B001/appliances/" + String(applianceNames[i]),
